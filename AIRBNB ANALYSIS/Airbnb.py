...
icon = Image.open("C:\\Users\\Gayathri\\OneDrive\\Desktop\\project 4\\image1.jpg")
st.set_page_config(page_title= "Airbnb Data Visualization | By Gayathri",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   )
st.markdown("<h1 style='text-align: center; color: #FF69B4;'>AIRBNB Analysis</h1>", unsafe_allow_html=True)
...
if selected == "Home":
    # Title Image
    st.image("C:\\Users\\Gayathri\\OneDrive\\Desktop\\proj4\\airbnb.png")
